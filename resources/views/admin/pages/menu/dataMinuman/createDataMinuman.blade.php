                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="card-title">Form Data Minuman Baru</h5>
                            </div>
                    ...
                    <!-- /.card-header -->
                    <form action="{{ route('storeDataMinuman') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="namaMinuman"
                                        ...
                                        value="{{ old('namaMinuman') }}" autocomplete="off">
                                    @error('namaMinuman')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
