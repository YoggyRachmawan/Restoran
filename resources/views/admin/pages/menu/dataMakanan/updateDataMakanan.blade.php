                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="card-title">Form Ubah Data Makanan</h5>
                            </div>
                    ...
                    <!-- /.card-header -->
                    <form action="{{ route('updateDataMakanan', $item->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="namaMakanan"
                                        ...
                                        value="{{ $item->namaMakanan }}" autocomplete="off">
                                    @error('namaMakanan')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
